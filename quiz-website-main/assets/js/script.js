...
function countdown() {
    var timerVar = setInterval(function() {
        if (timeLeft < 0) {
          ...
          userScoreEl.textContent = userScore + " out of " + 10 + " points";
        if (userScore <= 3) {
            userScoreMsgEl.textContent = "... What the hell is wrong with you Samara? Anyway since you're hot, you get a pass. Go back to the home page and click the timer in the top right corner";
        } else if (userScore > 3 && userScore <= 5) {
            userScoreMsgEl.textContent = "... This is bad, even for you Samara. Anyway since you're hot, you get a pass. Go back to the home page and click the timer in the top right corner";
        } else if (userScore > 5 && userScore <= 7) {
            userScoreMsgEl.textContent = "... Half-decent. For your reward, go back to the home page and click the top right corner";
        } else if (userScore > 7 && userScore <= 10) {
            userScoreMsgEl.textContent = "... Very well done Samara! Go back to the home page and click the top right corner for your reward! ";
            } else {
